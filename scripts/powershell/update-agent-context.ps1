...
function Update-SpecificAgent {
    ...
    switch ($Type) {
        ...
        'droid'    { Update-AgentFile -TargetFile $DROID_FILE    -AgentName 'Droid AI' }
...
function Update-AllExistingAgents {
    ...
    if (Test-Path $DROID_FILE)    { if (-not (Update-AgentFile -TargetFile $DROID_FILE    -AgentName 'Droid AI')) { $ok = $false }; $found = $true }
    if (-not $found) {
